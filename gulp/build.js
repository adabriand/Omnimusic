...
gulp.task('dist', ['lint', 'styles', 'uglify-angular-app', 'dist-html', 'dist-bower', 'dist-js', 'dist-base-css'], function () {
    ...
    var injectScripts = gulp.src([
        buildLib + '**/*.min.js', buildAppDir + '**/*.min.js'], {read: false}
    );
...
gulp.task('dist-dev', ['lint', 'styles'], function () {
    ...
    var injectScripts = gulp.src([
        sourceAppDir + '**/*.js', sourceLib + '**/*.js', '!' + sourceLib + '**/*.min.js',
    ]).pipe(angularFileSort());
